...
export default function CollaborateursPage() {
  ...
  const [stats, setStats] = useState({ total: 0, femmes: 0, hommes: 0, actifs: 0 });
      ...
      try {
        ...
        if (data.success) {
          ...
          setStats({
            ...
            femmes: collabs.filter((c: any) => c.genre === 'F').length,
            hommes: collabs.filter((c: any) => c.genre === 'M').length,
            actifs: collabs.filter((c: any) => {
